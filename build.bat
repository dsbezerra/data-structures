...
set CommonCompilerFlags=-Od -nologo -fp:fast -fp:except- -Gm- -GR- -EHa- -Oi -WX -W4 -wd4505 -wd4312 -wd4244 -wd4201 -wd4204 -wd4255 -wd4668 -wd4820 -wd4100 -wd4189 -wd4711 -wd4710 -wd4101 -wd4296 -wd4311 -wd4115 -wd4702 -wd4456 -wd4555 -wd4457 -wd4245 -wd4701 -FC -Zi -EHsc
...
del *.pdb > NUL 2> NUL
cl %CommonCompilerFlags% -D_CRT_SECURE_NO_WARNINGS ..\data-structures\main.cpp -Fmds_main.map /link %CommonLinkerFlags%

REM Release 64-bit build:
REM cl %ReleaseCompilerFlags% -D_CRT_SECURE_NO_WARNINGS ..\data-structures\main.cpp /link %CommonLinkerFlags%
